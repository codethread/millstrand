(ns millstrand.spools.workflow.cli
  ...
  workspace that activates `millstrand.spools.workflow` gets the engine, its
  ...
  Activate it beside the engine:
      ...
      (runtime/module! rt :millstrand/spools-workflow-cli
        {:ns 'millstrand.spools.workflow.cli
...
(defn seed-workflow-glossary!
  ...
  (doseq [outcome workflow-glossary]
    (glossary/register-glossary-outcome!
     runtime (assoc outcome :owner 'millstrand.spools.workflow.cli)))
...
(lifecycle/defseed workflow-glossary-seed
  ...
  {:apply 'millstrand.spools.workflow.cli/seed-workflow-glossary!})
