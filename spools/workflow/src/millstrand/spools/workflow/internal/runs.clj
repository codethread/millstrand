(ns millstrand.spools.workflow.internal.runs
...
(defn result
  ...
  (let [root (root-view rt run-id)
    ...
    (util/require-shape! :millstrand.spools.workflow/run-result
                         {:operation operation
                          :run-id run-id
                          :root root
                          :ready ready
...
(defn attention-result
  ...
  (util/require-shape! :millstrand.spools.workflow/attention-result
