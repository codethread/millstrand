(ns millstrand.api.registry.alpha
...
(s/def ::id :millstrand.core.weaver.owner-registry/id)
(s/def ::entry-spec :millstrand.core.weaver.owner-registry/entry-spec)
(s/def ::binding-moment :millstrand.core.weaver.owner-registry/binding-moment)
(s/def ::layer-policy :millstrand.core.weaver.owner-registry/layer-policy)
(s/def ::candidate-validator :millstrand.core.weaver.owner-registry/candidate-validator)
(s/def ::kind-id :millstrand.core.weaver.owner-registry/kind-id)
(s/def ::kind :millstrand.core.weaver.owner-registry/kind)
(s/def ::owner :millstrand.core.weaver.owner-registry/owner)
(s/def ::entry-key :millstrand.core.weaver.owner-registry/entry-key)
(s/def ::value :millstrand.core.weaver.owner-registry/value)
(s/def ::kind-declaration :millstrand.core.weaver.owner-registry/kind-declaration)
(s/def ::kind-declaration-input
  (s/and
   ...
   #(every? #{:id :entry-spec :binding-moment
            ...
            (keys %))))
(s/def ::partition :millstrand.core.weaver.owner-registry/partition)
(s/def ::snapshot :millstrand.core.weaver.owner-registry/snapshot)
(s/def ::status :millstrand.core.weaver.owner-registry/status)
(s/def ::mutation-result :millstrand.core.weaver.owner-registry/mutation-result)
(s/def ::provenance-entry :millstrand.core.weaver.owner-registry/provenance-entry)
