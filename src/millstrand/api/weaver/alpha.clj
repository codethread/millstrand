(ns millstrand.api.weaver.alpha
  ...
  (:require [clojure.spec.alpha :as s]
            ...
            [millstrand.api.weaver.internal.op-entry :as op-entry]
...
(defn- validated-op-entry
  ...
  `op-entry` plumbing; the reaches into the promised `millstrand.api.cli.alpha`
