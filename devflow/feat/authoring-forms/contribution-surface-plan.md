...
| --- | --- | --- | --- | --- | --- |
| `:ops` | core runtime | workspace `defop` prototype | `skein.api.millstrand.alpha/defop` | `skein.core.contribution/::op-options`, `::op-entry` | Skein API and tests |
| `:queries` | core runtime | workspace `defquery` prototype | `skein.api.millstrand.alpha/defquery` | `skein.core.contribution/::query-options`, `::query-entry` | Skein API and tests |
| `:patterns` | core runtime | workspace `defpattern`/`defp` prototypes | `skein.api.millstrand.alpha/defpattern`; no short alias | `skein.core.contribution/::pattern-options`, `::pattern-entry` | Skein API and tests |
| `:hooks` | core runtime | raw contribution maps | `skein.api.millstrand.alpha/defhook` | `skein.core.contribution/::hook-options`, `::hook-entry` | Skein API and tests |
| `:events` | core runtime | raw contribution maps | `skein.api.millstrand.alpha/defhandler` | `skein.core.contribution/::handler-options`, `::event-entry` | Skein API and tests |
...
```sh
clojure -M:test skein.api.millstrand-test skein.spools.workflow-test skein.spools.cron.runtime-test skein.chime-test skein.core.weaver.modules-test
```
