...
- **DELTA-Sad-003.CC4:** The coordinated userland migration is limited to Millhouse, agent-harness, devflow, and codethread. Their own contracts and release markers record their corresponding breaks. No compatibility claim is made for another spool repository; the unchanged Kanban source is consumed only through the Millstrand-owned adapter and fresh-generation constraint in `DELTA-Sad-002.CC7`.
