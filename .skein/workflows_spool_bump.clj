(ns workflows-spool-bump
  ...
  Bump, validate, land, and adopt a third-party spool release against the
  feature worktree's selected workspace."
...
(s/def ::family ::common/non-blank-string)
...
(s/def ::spool-bump-params
  (s/keys :req-un [::bumps ::common/branch ::common/worktree ::direct-user-request]))
