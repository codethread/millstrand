(ns workflows-explore
  "The open-ended `explore` workflow (family \"explore\").

  The zero-ceremony light mode: exploration always leaves a kanban card and
  worktree trail a later session can resume."
  (:require [clojure.spec.alpha :as s]
            [skein.api.format.alpha :as format-alpha]
            [skein.spools.workflow :as workflow]
            [workflows-common :as common]))

(s/def ::topic ::common/non-blank-string)
(s/def ::explore-params (s/keys :req-un [::topic] :opt-un [::common/card]))
