(ns millstrand.api.graph.alpha-test
  ...
  `millstrand.core.weaver.graph-query-test` and `millstrand.core.db-test`; this namespace pins the
  ...
  (t/with-weaver-world [ctx {:storage :sqlite-memory}]
    (let [rt (:runtime ctx)]
      (hooks/register-hook! rt :capture #{:strand/burn-before-commit}
                            'millstrand.api.graph.alpha-test/capture-hook {})
