...
| Approved-root/module | `test/fixtures/clojure/smoke-authoring/`, `test/fixtures/clojure/e2e-live-spool/`, and generated `:spools-edn`/`:files` worlds used with `millstrand.test.alpha`. | Root approval, source loading, module collection/publication, lifecycle, and refresh inside an embedded disposable weaver. |
...
## Live smoke scenarios and specifications
