(ns millstrand.core.weaver.registry-snapshots-test
  "Tests for owner registry snapshots and atomic publication."
  (:require [clojure.java.io :as io]
            ...
            [millstrand.core.weaver.lifecycle :as lifecycle]
...
(defn drain-events!
  ...
  (let [signal (promise)]
    ...
    (events/register-handler! rt :event-drain #{:test/event-drain}
                              'millstrand.core.weaver.registry-snapshots-test/event-drain-handler {})
    (try
...
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/feature plan-non-blank?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/title plan-non-blank?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/key plan-non-blank?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/body plan-non-blank?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/kind #{"task" "review"})
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/hitl boolean?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/depends_on
  (s/coll-of :millstrand.core.weaver.registry-snapshots-test.plan/key :kind vector?))
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/max-attempts pos-int?)
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/task
  (s/keys :req-un [:millstrand.core.weaver.registry-snapshots-test.plan/key :millstrand.core.weaver.registry-snapshots-test.plan/title]
          :opt-un [:millstrand.core.weaver.registry-snapshots-test.plan/body :millstrand.core.weaver.registry-snapshots-test.plan/kind
                   :millstrand.core.weaver.registry-snapshots-test.plan/hitl :millstrand.core.weaver.registry-snapshots-test.plan/depends_on
                   :millstrand.core.weaver.registry-snapshots-test.plan/max-attempts]))
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/tasks
  (s/coll-of :millstrand.core.weaver.registry-snapshots-test.plan/task :kind vector? :min-count 1))
(s/def :millstrand.core.weaver.registry-snapshots-test.plan/input
  (s/and map?
         #(every? #{:feature :title :tasks :body} (keys %))
         (s/keys :req-un [:millstrand.core.weaver.registry-snapshots-test.plan/feature :millstrand.core.weaver.registry-snapshots-test.plan/title
                          :millstrand.core.weaver.registry-snapshots-test.plan/tasks]
                 :opt-un [:millstrand.core.weaver.registry-snapshots-test.plan/body])))
(s/def :millstrand.core.weaver.registry-snapshots-test.pipeline/input
  (s/and map?
         #(s/valid? :millstrand.core.weaver.registry-snapshots-test.plan/tasks (:tasks %))))
  ...
  (with-runtime
    (fn [rt _db-file]
      (events/register-handler! rt :aaa-event-mutator #{:snap/event}
                                'millstrand.core.weaver.registry-snapshots-test/snapshot-event-mutator {})
      (events/register-handler! rt :zzz-event-victim #{:snap/event}
                                'millstrand.core.weaver.registry-snapshots-test/snapshot-event-victim {})
  ...
  (with-runtime
    (fn [rt _db-file]
      (events/register-handler! rt :faily #{:snap/fail}
                                'millstrand.core.weaver.registry-snapshots-test/failing-event {})
      ...
      (events/register-handler! rt :other #{:snap/other}
                                'millstrand.core.weaver.registry-snapshots-test/capture-event {})
      (is (= 1 (count (events/recent-failures rt)))
  ...
  (with-runtime
    (fn [rt _db-file]
      (hooks/register-hook! rt :aaa-hook-mutator #{:snap/hook}
                            'millstrand.core.weaver.registry-snapshots-test/snapshot-hook-mutator {:order 0})
      (hooks/register-hook! rt :zzz-hook-victim #{:snap/hook}
                            'millstrand.core.weaver.registry-snapshots-test/snapshot-hook-victim {:order 1})
