(ns skein.core.weaver.lifecycle-forms-test
...
(def ^:private test-ns (the-ns 'skein.core.weaver.lifecycle-forms-test))

(def ^:private context
  {:module/key :test/lifecycle
   :source/file (.getCanonicalPath (io/file *file*))
   :source/namespace 'skein.core.weaver.lifecycle-forms-test})
...
(deftest forms-collect-owner-complete-lifecycle-declarations
  (is (= :resource
         (:kind (lifecycle/resource-declaration
                 {:open 'skein.core.weaver.lifecycle-forms-test/sample-call
                  :close 'skein.core.weaver.lifecycle-forms-test/sample-call}))))
  (let [collected
        (collect-lifecycle
         #(eval
           '(do
              (lifecycle/defseed bootstrap "Bootstrap."
                {:apply 'skein.core.weaver.lifecycle-forms-test/sample-call})
