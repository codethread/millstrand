...
Resolves the two-argument transform through the runtime's generation classloader. The Batteries root must already be synced into the running weaver. Like direct registration, this fails loudly when the slot is occupied.
