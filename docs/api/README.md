...
| Namespace | Reach for it when |
| --- | --- |
| [`process`](./process.api.md) | Launching native work that must outlive Weaver replacement, then reading, cancelling, acknowledging, and reconciling Mill-retained process facts. |
