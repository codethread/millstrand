...
func TestHumanStatusRejectsMalformedFailureDetailsBeforePrinting(t *testing.T) {
	for _, fields := range []map[string]any{
		...
		{"state": "running", "restart_failure": map[string]any{"stage": "probe", "message": "failed", "log_path": 42}},
		{"state": "running", "restart_failure": map[string]any{"stage": "probe", "message": "failed", "exit_evidence": false}},
		{"state": "running", "restart_failure": map[string]any{"stage": "probe", "message": "failed", "unknown": "field"}},
