...
func runFreshRuntimeProbe(source string, world config.World) (restartProbeResult, error) {
	...
	cmd.Dir = source
	cmd.Env = append(os.Environ(), "MILLSTRAND_PROBE_SOURCE="+source, "MILLSTRAND_PROBE_CONFIG="+world.ConfigDir, "MILLSTRAND_PROBE_STATE="+world.StateDir, "MILLSTRAND_PROBE_DATA="+world.DataDir, "MILLSTRAND_PROBE_BASELINE_PATH="+baselinePath, "MILLSTRAND_PROBE_RESULT="+resultPath)
