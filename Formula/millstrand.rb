class Millstrand < Formula
  ...
  url "https://github.com/codethread/millstrand.git",
      branch:   "main",
      revision: "eca054a70c9afac876f279c4162b9919dc6eed76"
  version "0.5.3"
  ...
  def install
    ldflags = "-X millstrand-strand-cli/internal/config.InstalledSource=#{opt_libexec} " \
              ...
              "-X millstrand-strand-cli/internal/config.BuildID=eca054a70c9afac876f279c4162b9919dc6eed76"
  ...
  test do
    expected_identity = {
      "build_id"         => "eca054a70c9afac876f279c4162b9919dc6eed76",
      "protocol_version" => 3,
      "version"          => "0.5.3",
    }
    ...
    assert_match "## 0.5.3", shell_output("#{bin}/mill changelog")
